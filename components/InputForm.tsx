      ...
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-bold text-slate-700 mb-2">
            언어 <span className="text-red-500 text-xs ml-1">(필수)</span>
          </label>
          <div className="text-xs text-slate-500 mb-2">시나리오를 어떤 언어로 작성할지 선택하세요.</div>
        ...
        <div>
          <label className="block text-sm font-bold text-slate-700 mb-2">
            컨셉 <span className="text-red-500 text-xs ml-1">(필수)</span>
          </label>
        ...
        <div>
          ...
          <div className="text-xs text-slate-500 mb-2">어떤 형식으로 보여줄까요?</div>
          <div className="flex flex-wrap gap-3">
        ...
        <div>
          ...
          <div className="text-xs text-slate-500 mb-2">주인공/등장인물을 설명해 주세요.</div>
          <textarea
            id="character"
        ...
        <div>
          ...
          <div className="text-xs text-slate-500 mb-2">줄거리/상황을 자유롭게 입력해 주세요.</div>
          <textarea
            id="scenario"
